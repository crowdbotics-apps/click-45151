"""
Django settings for click_45151 project.
...
WSGI_APPLICATION = 'click_45151.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "click_45151 API",
    "DESCRIPTION": "API documentation for click_45151 App",
    "VERSION": "v1",
}
